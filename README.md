...
```bash
curl -sL https://github.com/munkycool/minecraft-server/raw/refs/heads/main/installer/bootstrap | sudo bash
...
You may want to [review](https://github.com/munkycool/minecraft-server/blob/main/installer/bootstrap) the script before executing it.
